...
const cards = [
  {
    ...
    description:
      "Explore the latest trends in cybersecurity and ethical hacking.",
  ...
  return (
    <div className="flex flex-col items-center min-h-screen pt-20 pb-16 px-4">
      <div className="text-center max-w-6xl  my-5 md:my-10">
        <h1 className=" text-2xl md:text-4xl font-bolder text-blue-600 dm-sans">
          Welcome to Dhruva 2025!
        </h1>
        <p className="text-gray-800 text-md mt-2">
          Join us for an electrifying <b>Tech, Cultural, and Sports Fest</b>{" "}
          filled with
